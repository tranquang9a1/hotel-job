                ...
                for (int i = 4193; i < 4300; i++) {
                    ...
                    for (Element ref : refs) {
                        ...
                        try {
                            ...
                            boolean result = DBConnection.addJob(jobID, jobName, salary, description, required, deadline, null, domainName, number, companyid, null, cityName, positionName, null, null, timeInfo);
                            if (result) {
